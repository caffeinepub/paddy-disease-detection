...
export class Backend implements backendInterface {
    ...
    async getAllDiseases(): Promise<Array<[number, Disease]>> {
    ...
    async getDisease(arg0: number): Promise<Disease> {
        if (this.processError) {
            try {
    ...
    async simulateDetection(arg0: string, arg1: number): Promise<number | null> {
        if (this.processError) {
            try {
                const result = await this.actor.simulateDetection(arg0, arg1);
